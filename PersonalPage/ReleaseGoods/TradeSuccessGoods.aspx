<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TradeSuccessGoods.aspx.cs" Inherits="TradeSuccessGoods" %>
                ...
                <div class="user-foot">
                    ...
                    <div class="am-cf am-padding">
                        <div class="am-fl am-cf">
                            <strong class="am-text-danger am-text-lg">成功交易的商品</strong> / <small>Successful&nbsp;Trade&nbsp;Goods</small></div>
                    </div>
                    <hr />
                    <!--成功交易的商品列表 -->
                    <%
                        ...
                        <div class="goods-box first-box">
                            <div class="goods-pic">
                                ...
                                <a class="goods-delete" href="javascript:void(0);">
                                    <img src="../../home/images/chenggong.png" />
                                </a>
                                <div class="goods-status goods-status-show">
                                    <span class="desc">交易成功</span></div>
                            </div>
