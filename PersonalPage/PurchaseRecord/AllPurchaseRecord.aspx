<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllPurchaseRecord.aspx.cs" Inherits="PersonalPage_PurchaseRecord_AllPurchaseRecord" %>
...
<div class="am-cf am-padding">
    <div class="am-fl am-cf">
        <strong class="am-text-danger am-text-lg">我的所有云购记录</strong></div>
</div>
<hr />
...
<div class="footer">
    ...
    <div class="footer-bd">
        <p>
            <a href="#">关于二手云购</a> <em>2017-2018 CloudMarket.com 版权所有.
            </em>
        </p>
    </div>
</div>
