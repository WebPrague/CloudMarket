                                        ...
                                        <li class="td td-item">
                                            <div class="item-pic">
                                                <a href="#" class="J_MakePoint">
                                                    <img src="<%=shopcar.good.Picurl%>" class="itempic J_ItemImg" style="height: 80px; width: 80px;"></a>
                                            </div>
                                            <div class="item-info">
                                                <div class="item-basic-info">
                                                    <a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11"><%=shopcar.good.Goodname%></a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="td td-info">
                                            <div class="item-props">
                                                <span class="sku-line">价值：￥<%=shopcar.good.Joinpeoplenum%>.00</span>
                                                <br/>
                                                <span class="sku-line">剩余：<%=shopcar.good.RemainPeople%></span>
                                            </div>
                                        </li>
                                    </div>
